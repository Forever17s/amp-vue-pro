...
<script>
  import { use } from 'src/common/locale';
  import zhLocale from 'src/common/locale/lang/zh-CN';
//  import enLocale from 'src/common/locale/lang/en';
