  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a href="https://github.com/ElementUI/theme-default-preview" class="footer-main-link" target="_blank">{{ langConfig.preview }}</a>
        <a href="https://github.com/eleme/element-react" class="footer-main-link" target="_blank">PYFF-React</a>
        <a href="https://github.com/eleme/element-angular" class="footer-main-link" target="_blank">PYFF-Angular</a>
      </div>
      <div class="footer-main">
        ...
        <a href="https://github.com/ElementUI/awesome-element" class="footer-main-link" target="_blank">Awesome PYFF</a>
      </div>
      <div class="footer-social">
        <p class="footer-social-title">PYFF {{ version && version.slice(0, 3) }} Carbon</p>
        <py-popover
          ref="weixin"
          placement="top"
          width="120"
...
<script type="text/babel">
  ...
  import { version } from '../../src/components/index.js';
