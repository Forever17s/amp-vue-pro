...
<style>
  ...
  .theme-picker .py-color-picker__trigger {
    vertical-align: middle;
  }

  .theme-picker-dropdown .py-color-dropdown__link-btn {
    display: none;
  }
</style>
...
<script>
  ...
  export default {
    data() {
      return {
        chalk: '', // content of theme-default css
    ...
    watch: {
      theme(val, oldVal) {
        ...
        if (!this.chalk) {
          const url = `https://unpkg.com/element-ui@${ version }/lib/theme-default/src/index.scss`;
