<template>
  <div class="py-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <py-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="py-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="py-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="py-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="py-time-spinner__arrow py-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="py-time-spinner__arrow py-icon-arrow-down"></i>
        <ul class="py-time-spinner__list" ref="hours">
          <li
            class="py-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="py-time-spinner__arrow py-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="py-time-spinner__arrow py-icon-arrow-down"></i>
        <ul class="py-time-spinner__list" ref="minutes">
          <li
            class="py-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="py-time-spinner__arrow py-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="py-time-spinner__arrow py-icon-arrow-down"></i>
        <ul class="py-time-spinner__list" ref="seconds">
          <li
            class="py-time-spinner__item"
...
<script type="text/babel">
  ...
  import RepeatClick from 'src/common/directives/repeat-click';
