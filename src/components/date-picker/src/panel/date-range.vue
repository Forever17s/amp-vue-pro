<template>
  <transition name="py-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="py-picker-panel py-date-range-picker py-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="py-picker-panel__body-wrapper">
        <slot name="sidebar" class="py-picker-panel__sidebar"></slot>
        <div class="py-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="py-picker-panel__shortcut"
            v-for="shortcut in shortcuts"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="py-picker-panel__body">
          <div class="py-date-range-picker__time-header" v-if="showTime">
            <span class="py-date-range-picker__editors-wrap">
              <span class="py-date-range-picker__time-picker-wrap">
                <py-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="py-date-range-picker__editor"
            ...
            <span class="py-icon-arrow-right"></span>
            <span class="py-date-range-picker__editors-wrap is-right">
              <span class="py-date-range-picker__time-picker-wrap">
                <py-input
                  size="small"
                  :disabled="rangeState.selecting"
          ...
          <div class="py-picker-panel__content py-date-range-picker__content is-left">
            <div class="py-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="py-picker-panel__icon-btn py-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="py-picker-panel__icon-btn py-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="py-picker-panel__icon-btn py-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="py-picker-panel__icon-btn py-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="py-picker-panel__content py-date-range-picker__content is-right">
            <div class="py-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="py-picker-panel__footer" v-if="showTime">
        <py-button
          size="mini"
          type="text"
          class="py-picker-panel__link-btn"
          @click="handleClear">
...
<script type="text/babel">
  ...
  import Locale from 'src/common/mixins/locale';
  ...
  export default {
    ...
    components: { TimePicker, DateTable, PyInput, PyButton }
  };
</script>
