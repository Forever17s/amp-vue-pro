<template>
  <transition name="py-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="py-picker-panel py-date-picker py-popper"
      :class="[{
      ...
      <div class="py-picker-panel__body-wrapper">
        ...
        <div class="py-picker-panel__body">
          <div class="py-date-picker__time-header" v-if="showTime">
            <span class="py-date-picker__editor-wrap">
              <py-input
          ...
          <div
            class="py-date-picker__header"
            :class="{ 'py-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              :aria-label="t(`el.datepicker.prevYear`)"
              class="py-picker-panel__icon-btn py-date-picker__prev-btn py-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              class="py-picker-panel__icon-btn py-date-picker__prev-btn py-icon-arrow-left">
            </button>
            <span
              @click="showYearPicker"
              role="button"
              class="py-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="py-date-picker__header-label"
              :class="{ active: currentView === 'month' }">{{t(`el.datepicker.month${ month + 1 }`)}}</span>
            <button
              type="button"
              @click="nextYear"
              :aria-label="t(`el.datepicker.nextYear`)"
              class="py-picker-panel__icon-btn py-date-picker__next-btn py-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              class="py-picker-panel__icon-btn py-date-picker__next-btn py-icon-arrow-right">
            </button>
          </div>

          <div class="py-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, PyInput, PyButton
    },
