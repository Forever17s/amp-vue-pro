<template>
  <transition
    ...
    <div
      v-show="visible"
      class="py-time-range-picker py-picker-panel py-popper"
      :class="popperClass">
      <div class="py-time-range-picker__content">
        <div class="py-time-range-picker__cell">
          <div class="py-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="py-time-range-picker__body py-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="py-time-range-picker__cell">
          <div class="py-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="py-time-range-picker__body py-time-panel__content">
            <time-spinner
      ...
      <div class="py-time-panel__footer">
        <button
          type="button"
          class="py-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="py-time-panel__btn confirm"
          @click="handleConfirm()"
