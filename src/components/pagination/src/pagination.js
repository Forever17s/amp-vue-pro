...
import PySelect from '../../select';
import PyOption from '../../option';
...
export default {
  ...
  render(h) {
    let template = <div class={['py-pagination', {
    ...
    const rightWrapper = <div class="py-pagination__rightwrapper"></div>;
  ...
  components: {
          ...
          <button
            ...
            on-click={ this.$parent.prev }>
            {
              this.$parent.prevText
                ...
                : <i class="py-icon py-icon-arrow-left"></i>
            }
          </button>
        );
      }
          ...
          <button
            ...
            on-click={ this.$parent.next }>
            {
              this.$parent.nextText
                ...
                : <i class="py-icon py-icon-arrow-right"></i>
            }
          </button>
        );
      }
    ...
    Sizes: {
      ...
      render(h) {
        return (
          <span class="py-pagination__sizes">
            <py-select
    ...
    Jumper: {
      ...
      render(h) {
        return (
          <span class="py-pagination__jump">
            { this.t('el.pagination.goto') }
            <py-input
              class="py-pagination__editor is-in-pagination"
              min={ 1 }
      ...
      render(h) {
        return (
          typeof this.$parent.total === 'number'
            ? <span class="py-pagination__total">{ this.t('el.pagination.total', { total: this.$parent.total }) }</span>
            : ''
        );
      }
    },
