<template>
  <div class="py-slider"
    :class="{ 'is-vertical': vertical, 'py-slider--with-input': showInput }"
     role="slider"
     :aria-valuemin="min"
     :aria-valuemax="max"
  ...
  >
    ...
    <div class="py-slider__runway"
      :class="{ 'show-input': showInput, 'disabled': disabled }"
      :style="runwayStyle"
      @click="onSliderClick"
      ref="slider">
      <div
        class="py-slider__bar"
        :style="barStyle">
      </div>
      <slider-button
        :vertical="vertical"
...
<script type="text/babel">
  import PyInputNumber from '../../input-number';
        ...
        if (this.range && Array.isArray(val)) {
          if (val[1] < this.min) {
            ...
            if (this.valueChanged()) {
              this.dispatch('PyFormItem', 'el.form.change', [this.minValue, this.maxValue]);
