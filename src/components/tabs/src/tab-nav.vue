<script>
  ...
  export default {
    ...
    render(h) {
      ...
      ? [
        <span class={['py-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled']} on-click={scrollPrev}><i class="py-icon-arrow-left"></i></span>,
        <span class={['py-tabs__nav-next', scrollable.next ? '' : 'is-disabled']} on-click={scrollNext}><i class="py-icon-arrow-right"></i></span>
      ] : null;
      ...
      const tabs = this._l(panes, (pane, index) => {
        ...
        const btnClose = closable
          ? <span class="py-icon-close" on-click={(ev) => { onTabRemove(pane, ev); }}></span>
          : null;
      ...
      return (
        <div class={['py-tabs__nav-wrap', scrollable ? 'is-scrollable' : '']}>
          {scrollBtn}
          <div class={['py-tabs__nav-scroll']} ref="navScroll">
            <div class="py-tabs__nav" ref="nav" style={navStyle} role="tablist" on-keydown={ changeTab }>
