...
import { getFirstComponentChild } from 'src/common/utils/vdom';
...
export default {
  ...
  render(h) {
      ...
      this.popperVM.node = (
        <transition
          ...
          <div
            ...
            class={
              ['py-tooltip__popper', 'is-' + this.effect, this.popperClass]
            }>
    ...
    data.staticClass = this.concatClass(data.staticClass, 'py-tooltip');
