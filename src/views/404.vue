<template>
  <div>
    <py-button-group style="display: block; margin: 5% auto;width: 243px;">
      <py-button type="danger" suffix-icon="arrow-left" @click="returnLastPage"
        >返回上一页</py-button
      >
      <py-button type="danger" @click="returnFirstPage"
        >返回首页<i class="py-icon-arrow-right py-icon--right"></i
      ></py-button>
    </py-button-group>
    <svg
      id="robot"
